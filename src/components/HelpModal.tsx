...
const GLOBAL_EXPRESSIONS: BlockDoc = {
  ...
  inputs: [
    ...
    "pi() — constante Pi",
    "uptime() — temps écoulé depuis le lancement en ms",
    "vectdiff(a, b) — soustraction de deux arrays élément par élément",
    "vectshift(a, b) — décalage (b - a)",
    "setdiff(a, b) — différence entre deux ensembles/arrays",
    "setintersect(a, b, ...) — intersection entre ensembles",
    "max(a, b, ...) — valeur ou tableau de longueur maximale",
    "min(a, b, ...) — valeur ou tableau de longueur minimale",
    "select(obj, debut, [longueur]) — sous-partie d'array, dict ou chaîne",
    "sort(array, [croissant=true]) — trie un tableau",
  ],
  notes: [
